...
type UserServiceClient interface {
	...
	ConfirmationRegister(ctx context.Context, in *ConfirmationReq, opts ...grpc.CallOption) (*ConfirmationRes, error)
...
func (c *userServiceClient) ConfirmationRegister(ctx context.Context, in *ConfirmationReq, opts ...grpc.CallOption) (*ConfirmationRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	ConfirmationRegister(context.Context, *ConfirmationReq) (*ConfirmationRes, error)
...
func (UnimplementedUserServiceServer) ConfirmationRegister(context.Context, *ConfirmationReq) (*ConfirmationRes, error) {
...
func _UserService_ConfirmationRegister_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ConfirmationRegister(ctx, req.(*ConfirmationReq))
	}
	return interceptor(ctx, in, info, handler)
}
